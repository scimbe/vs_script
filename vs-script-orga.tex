...
\item Data Structures und Algorithms in Python von ohn Canning, Alan Broder und Robert Lafore \cite{canning_broder_lafore_2023}
\end{itemize}
\\\\ 
Ausreichende Kenntnisse aus Programmierung, Datenbanken, Betriebssysteme, Rechnernetze, Softwaretechnik (SE) und Algorithmen und Datenstrukturen werden erwartet. 
\\\\
...
\\\\
Weiter ist eine erweiterte Literatur Distributed Algorithms von Wan Fokkink \cite{Fokkink2018}. 
\newpage
\subsection{Woche 1}
Wer die Veranstaltung im Skript bereits vorbereiten möchte, kann gerne bis Seite \pageref{Woche01}ff (Textstelle~\ref{Woche01})vorbereiten. Dies ist aber nicht zwingend zum Verständnis der Vorlesung, wird dann aber als Nachbereitung angeraten.
\\\\
...
\subsection{Woche 2}
Wer die Veranstaltung am Donnerstag im Skript bereits vorbereiten möchte, kann gerne bis Seite \pageref{Woche02}ff (Textstelle~\ref{Woche02}) lesen. Dies ist aber nicht zwingend zum Verständnis der Vorlesung, wird dann aber als Nachbereitung angeraten.
\\\\
Idee zum Praktikum: Umsetzung der funktionalen Zerlegung. Bereichern Sie \enquote{bereits erlerntes} Anforderungsmanagement um die Themen Shared Resources, Openess, Transparency und Scaling. Dies ist der Startschuss für das Requirement-Management und die Entwicklung einer Lösungsstrategie im Praktikum (SE). 
\\\\
...
\\\\
Die Entwicklung einer Lösungsstrategie für verteilte Systeme erfordert eine sorgfältige Planung und Analyse. Im Folgenden ist eine Auflistung von Punkten , an die ihr im Praktikum denken solltet. 
...
\subsection{Woche 11}
Wer die Veranstaltung im Skript bereits vorbereiten möchte, kann gerne bis Seite \pageref{Woche11}ff (Textstelle~\ref{Woche11}).
Nun stehen auch die ersten Termine für das Testat an. Bitte beachtet die Termine!

\subsection{Woche 12}
Wer die Veranstaltung  im Skript bereits vorbereiten möchte, kann gerne bis Seite \pageref{Woche12}ff (Textstelle~\ref{Woche12}).
...
\item Für die PVL Vergabe müssen im Vorfeld zwei persönliche (!) (online) Gespräche über den aktuellen Stand des Projektes mit den Lehrenden gehalten werden. Wir bezeihnen diese Gespräche als 1:1 Gespräche.  Hier ist der aktuelle Stand des Projektes mit den Lehrenden zu diskutieren. 
\end{itemize}
