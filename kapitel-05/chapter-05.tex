...
Viele der Institutionen, auf die wir als moderne Gesellschaft angewiesen sind - Krankenhäuser, Banken, Börsen und Flughäfen - benötigen hochzuverlässige und stets verfügbare Computersysteme, um funktionieren zu können. Leider sind einzelne Maschinen dieser Herausforderung nicht gewachsen. Sie sind anfällig für Ausfälle und Stillstandzeiten und bedürfen regelmäßiger Wartung. Die Lösung besteht natürlich darin, mehrere Maschinen für dieselbe Aufgabe einzusetzen. 
\warningvs{
Doch wie bringen wir sie dazu sich gemeinsam zu koordinieren? 
}
...
%\subsubsection{Paxos (mehr Details)}\footnote{\url{https://www.youtube.com/watch?v=JQss0uQUc6o}, \url{https://www.youtube.com/watch?v=d7nAGI_NZPk}}
...
%Hier ist eine vereinfachte Beispielsequenz \ref{fig:simple-paxos}, die den Paxos-Algorithmus darstellt:
%\begin{figure}[htp!]
%  \centering
...
%\end{itemize}
%Um die Komplexität der Szenarien zu demonstrieren soll eine Beispielsequenz zu illustriert werden, so können wir das vorherige Diagramm modifizieren, um die Auswirkungen von Netzwerk- und Prozessausfällen zu zeigen:
%\begin{figure}[!ht]
%  \centering
...
%\subsubsection{Raft (mehr Details)}\footnote{\url{https://www.youtube.com/watch?v=ro2fU8_mr2w}}
...
%\subsubsection{ZAB (mehr Details)s}
...
Die grundlegende Idee hinter der Unmöglichkeit der Wahl in anonymen Ringen ist, dass jeder Algorithmus, der versucht, eine Wahl durchzuführen, in einem symmetrischen Zustand enden muss, in dem alle Knoten denselben Zustand haben. Da alle Knoten identisch sind, gibt es keine Möglichkeit, einen Knoten auf eine Art und Weise zu berechnen, die alle Knoten dazu bringen würde, übereinstimmend einen Leader zu wählen.
\\\\
