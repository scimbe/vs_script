...
Client-Server-Architektur versucht, man \textbf{falls möglich, zustandslos} zu designen. Zustandslos bedeutet bedeuted in diesem Zusammenhang, dass sie keine Informationen über den aktuellen Zustand eines Clients zwischen den Anfragen speichern. 

\importantvs{
    Zustandslos in VS: Keine Abhängigkeit der Nachrichten zueinander!
}
