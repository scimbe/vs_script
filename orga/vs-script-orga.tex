...
\importantvs{Ausreichende Kenntnisse aus Programmierung, Datenbanken, Betriebssysteme, Rechnernetze, Softwaretechnik (SE) und Algorithmen und Datenstrukturen werden erwartet. Weitere Beispiele werden noch folgen. Insbesondere sind auch diese gelben Texte dafür gedacht, wichtige Aspekte nochmal hervorzustellen.}
...
\\\\
Was man auch an dieser blauen Box erkennen kann, ist das blaue Boxen weitere Informationen abieten, die den Leser helfen können, aber nicht müssen.
}
