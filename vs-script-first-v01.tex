...
\input{kapitel-01/einleitung-verteilte-systeme}
\input{kapitel-01/definition-verteilte-systeme}
\input{kapitel-01/abgrenzung-ai-its}
\input{kapitel-01/ziele}
% Termin 2 - vs-slides-chapter01-2
\input{kapitel-01/ziele-detail}
\newpage
% Termin 2 - vs-slides-chapter01-2
...
\input{kapitel-02/realisierung}
%Termin-3 - vs-slides-chapter02-1
 
\input{kapitel-02/architekturen}
%Termin-4 - vs-slides-chapter02-2

\input{kapitel-02/pattern}
...
\input{kapitel-02/rpc-architecture}
\input{kapitel-02/chord-architecture}
%Termin-6 - vs-slides-chapter02-5

\newpage
% Work in progress
\section{Realisierung}
Bei der Implementierung von verteilten Systemen müssen mehrere Aspekte berücksichtigt werden, um sicherzustellen, dass das System effizient, zuverlässig und skalierbar ist. Eine umfassende Erörterung der Anforderungen in der Implementierung zu diksutieren ist aussichtslos, da eine nicht erfassbare Menge von Faktoren Einfluss haben. In den folgenden Punkten soll sich auf die grundsätzliche Anforderungen an Prozesse und Kommunikations konzentriert werden. In den weiteren Kapiteln werden besondere Aspekte der Algorithmik, Koordination, Adressierung und Fehlertoleranz in verteilten Systemen addressiert, bevor sich das Script dem Testen und  dem Deployment zuwendet. 
\input{kapitel-03/prozess}

%Termin-7 - vs-slides-chapter03-1
\newpage
\input{kapitel-03/kommunikation}

%Termin-8 - vs-slides-chapter03-2
\newpage
%vs-slides-chapter04-1 koordination
\input{kapitel-04/koordination}
\input{kapitel-04/sync}
%Termin-9 -
\input{kapitel-04/konsens}
%Termin-10 - Konsens mit Raft und Paxos Algorithmus

\newpage
\input{kapitel-05/algorithmen}
%Termin-11 -

\newpage

\input{kapitel-06/monitoring}
\input{kapitel-06/debugging}
\input{kapitel-06/deployment}
%Termin-12 -
