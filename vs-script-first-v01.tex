...
2025 WiSe Jana Geske (Rechtschreibung 4x)\\
...
2025 WiSe Raffael Wolpers (Rechtschreibung 1x)\\
2025 WiSe Fiona Lublow (Eindeutigkeit Transparenz)\\
2025 WiSe Ductin Hua (Link Hit)\\
\\
%%%%%%%%%%%%%% Inhaltsverzeichnis %%%%%%%%%%%%%%%%%%%%%%%
\tableofcontents
\newpage
